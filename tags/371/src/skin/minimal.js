...
GRP.minimal = function(){
    function toggle_gr(){
		...
		css += "#viewer-header,#logo-container,#search,#search-input#,search-restrict,#search-restrict-input,#search-submit,#chrome-header,#global-info,#gb,#top-bar,#viewer-footer{display:none !important;}";
