...
var grp_black = function() {
	...
	// General Google Page enhancements	
		...
		/* CONDITIONAL-EVALUATION related to Homepage Special Logo [exception for g.Images-homepage] */
		   (((getEl('logo') && getEl('logo').alt == 'Google') || location.href.indexOf('images.google.') > -1) ? 
	...
	// BRUTE-FORCE for "less cooperative" sites (each URI validated)
		...
		function sIR(style) {getEl('bruteForce').sheet.insertRule(style, 0);}
	...
	if (getEl('gSearchSidebar') == null) resW = 96;
