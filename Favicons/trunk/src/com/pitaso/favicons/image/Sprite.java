...
public class Sprite {
/*
    public void makeSprite() throws ImageReadException, IOException, ImageWriteException {
	...
	// methods of Sanselan usually accept files, byte arrays, or
	// inputstreams as arguments.
