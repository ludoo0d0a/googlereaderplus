...
GRP.langs[locale].prefs = {
    ...
    about: {
        ...
        '<p><a href="https://chrome.google.com/extensions/detail/hhcknjkmaaeinhdjgimjnophgpbdgfmg" target="_blank" title="Vizitaţi site-ul extensiei"><strong>Vizitaţi galeria Google Chrome Extensions!</strong></a></p>' +
...
﻿  ﻿  color:"Culoare text"
    ...
    general: {
        ...
        icontoolbar_add: "Pentru a adăuga un buton cu iconiţă în bara de instrumente, vă rog <a href=\"https://chrome.google.com/extensions/detail/ecpcafinfpjgabomoamkhkgnpgpmdmeo\">să-i descărcaţi şi instalaţi</a>.",
        icontoolbar_text: "<span>Pentru a face butonul opţional, o să-l punem intr-o altă extensie ca de sinestătător,</span>                                    <br>                                    <span>a fi instalat cu readerplus.</span>                                    <br>                                    <span>Pentru a adăuga butonul, click <b></b> pe pagina <a href=\"https://chrome.google.com/extensions/detail/ecpcafinfpjgabomoamkhkgnpgpmdmeo\">butonului din bara de instrumente readerplus</a>.</span><span>Pentru a şterge un buton, da-ţi click dreapta şi selectaţi Deactivare.</span>",
