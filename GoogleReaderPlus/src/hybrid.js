/**
 *  Mode hybrid = mode between card and list
 *  list with bigger row + picture 
 */
GRP.hybrid = function(prefs, langs, ID, SL, lang){
	var btnMode, mycss='';
	var ICONS_PATH = 'http://googlereaderplus.googlecode.com/svn/trunk/GoogleReaderPlus/images/toolbar/black/';
	...
	function render(){
		btnMode = dh('stream-view-options-container', 'div', {
			...
			title:'Hybrid mode',
			html: '<img src="'+ICONS_PATH+'hybrid.png" style="width: 21px; height: 21px; " class="jfk-button-img">'
		},{click:function(e){
			toggleTheme();
		}});
	}
    ...
    function toggleTheme(){
    	...
    	addClassIf(btnMode, 'jfk-button-checked', mycss);
    }
